...
while True:
    ...
    pyautogui.screenshot("resimler/resim{}.png".format(sayi))
    time.sleep(0.1)
    image = cv2.imread("resimler/resim{}.png".format(sayi))
    ...
    for i, indexes in enumerate(frame_indexes):
        cv2.imwrite("C:/Users/selim/PycharmProjects/Signal_Processing/frames/frame{}.png".format(i), image[indexes[2]: indexes[3], indexes[0]: indexes[1]])
